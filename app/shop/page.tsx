      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        ...
        <div className="flex flex-col w-full space-y-5">
          ...
          <Pagination className="justify-between">
            ...
            <PaginationContent>
              <PaginationItem>
                <PaginationLink href="#" className="text-black/50 font-medium text-sm" isActive size={undefined}>
                  1
                </PaginationLink>
              </PaginationItem>
              <PaginationItem>
                <PaginationLink href="#" className="text-black/50 font-medium text-sm" size={undefined}>
                  2
                </PaginationLink>
              </PaginationItem>
